...
type AdminData = {
  connection:{status:string;source:string;checkedAt:string};
...
export default function AdminPage() {
  ...
  if(loading)return <main className="admin-shell"><div className="public-loader"><span className="brand-mark">F</span><p>Chargement du centre de contrôle…</p></div></main>;

...
export default function Home() {
  ...
  async function markNotificationRead(item:NotificationReminder) {
    ...
    await csrfFetch("/api/notifications", { method:"POST", headers:{"content-type":"application/json"}, body:JSON.stringify({ action:"read", notificationId:item.notification_id }) });

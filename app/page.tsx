...
export default function Home() {
  ...
  const unreadReminderCount = notificationReminders.length ? notificationReminders.filter((item)=>!item.read).length : reminders.length;

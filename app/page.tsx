...
const emptyProfile: Profile = { target_title:"",location:"",contract_type:"",skills:"",experience_level:"",education_level:"",languages:"",sectors:"",salary_min:0 };
...
export default function Home() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      setApplications(appsData.applications ?? []); setProfile(profileData.profile ?? null);
  ...
  async function saveProfile(form:FormData) {
    ...
    setModal(null); notify("Profil de scoring enregistré");
  }
  ...
  return <main className="app-shell">
    ...
    <section className="content" id="dashboard">
      ...
      <div className="page-wrap">
        <div className="welcome-row"><div><p className="eyebrow">ESPACE DE TRAVAIL SÉCURISÉ</p><h1>Votre recherche, sous contrôle.</h1><p>Chaque donnée affichée provient désormais de votre espace personnel.</p><div className="concept-strip"><span>NEUROPATH</span><span>EDGE / SPATIAL</span><span>DONNÉES RÉELLES</span></div></div><button className="ghost-button" onClick={()=>setModal("profile")}>{profile?"Modifier mon profil":"Configurer mon profil"} →</button></div>
